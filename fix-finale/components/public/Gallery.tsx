...
export default function Gallery() {
  const { t } = useLocale()
  // Foto verificate: masseria, ulivi, campagna pugliese, cibo
  const photos = [
    { src: 'https://images.unsplash.com/photo-1602343168117-bb8ffe3e2e9f?w=800&q=80', alt: 'Masseria pugliese' },
    { src: 'https://images.unsplash.com/photo-1565538810643-b5bdb714032a?w=800&q=80', alt: 'Ulivi secolari' },
    { src: 'https://images.unsplash.com/photo-1533104816931-20fa691ff6ca?w=800&q=80', alt: 'Campagna Valle Itria' },
    { src: 'https://images.unsplash.com/photo-1473093295043-cdd812d0e601?w=800&q=80', alt: 'Cucina mediterranea' },
  ]
  return (
