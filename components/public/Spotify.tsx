...
export default function Spotify() {
  ...
  const copy = {
    it: {
      ...
      body:     "Aprite Spotify, cercate la playlist \"Let's Dance\" e aggiungete le vostre tracce preferite. Più siamo, più la sera sarà indimenticabile.",
      cta:      "Apri su Spotify →",
    },
    en: {
      ...
      body:     "Open Spotify, find the playlist \"Let's Dance\" and add your favourite tracks. The more the merrier — let's make it unforgettable.",
      cta:      "Open on Spotify →",
    },
  }
